...
public class ToolUltimateDiamondPickaxe extends ItemPickaxe {

	public ToolUltimateDiamondPickaxe(final Item.ToolMaterial mat) {
		super(mat);
	}
	...
	public void registerIcons(final IIconRegister reg) {
		this.itemIcon = reg.registerIcon("diamondcraft:ultimatediamond_pickaxe");
	}

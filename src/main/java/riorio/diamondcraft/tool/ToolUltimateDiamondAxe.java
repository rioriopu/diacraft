...
public class ToolUltimateDiamondAxe extends ItemAxe {

	public ToolUltimateDiamondAxe(final Item.ToolMaterial mat) {
		super(mat);
	}
	...
	public void registerIcons(final IIconRegister reg) {
		this.itemIcon = reg.registerIcon("diamondcraft:ultimatediamond_axe");
	}

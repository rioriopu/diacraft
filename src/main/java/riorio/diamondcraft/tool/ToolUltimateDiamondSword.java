...
public class ToolUltimateDiamondSword extends ItemSword {

	protected final float weaponDamage;

	public ToolUltimateDiamondSword(final Item.ToolMaterial mat, final float damage) {
		super(mat);
	...
	public void registerIcons(final IIconRegister reg) {
		this.itemIcon = reg.registerIcon("diamondcraft:ultimatediamond_sword");
	...
	public void onUpdate(final ItemStack stack, final World world, final Entity entity, final int par4, final boolean par5) {
		super.onUpdate(stack, world, entity, par4, par5);
		{
			...
			if (equipped==stack)
				player.addPotionEffect(new PotionEffect(Potion.damageBoost.getId(), 99999, 0));
			player.addPotionEffect(new PotionEffect(Potion.heal.getId(), 99999, 0));
		}
	}
